# shamelessly taken from distrotube, and with some personal changes
...
c.url.start_pages = ['https://www.google.com', 'https://raw.githubusercontent.com/qutebrowser/qutebrowser/master/doc/img/cheatsheet-big.png']
...
# addtional misc bindings
config.bind('<Ctrl-f>', 'set-cmd-text -s /')
